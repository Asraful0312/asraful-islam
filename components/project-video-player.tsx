...
export const ProjectVideoPlayer = ({ videoUrl }: { videoUrl: string }) => {
...
const VideoPopOver = ({
  ...
  return (
    <div className="fixed left-0 top-0 z-[101] flex h-full w-full items-center justify-center">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      ...
      <motion.div
        ...
        className="relative aspect-video w-full max-w-6xl mx-auto flex items-center justify-center"
      >
        <VideoPlayer className="w-full h-[85%]">
          <VideoPlayerContent
            src={videoUrl}
            autoPlay
            slot="media"
