      ...
      >
        ...
        >
          <div className="flex flex-col gap-6">
            ...
            >
              <div className="inline-block px-3 py-1 mb-4 text-sm font-medium tracking-wider text-white uppercase bg-jordy_blue-900/20 rounded-full border border-jordy_blue-500/20 backdrop-blur-sm">
            ...
            >
              <Button
                asChild
                size="lg"
                className="bg-white text-black hover:bg-slate-200 rounded-full px-8 font-semibold shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_25px_rgba(255,255,255,0.45)] transition-all duration-300"
              >
                <Link href="/#projects">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-white/20 text-white hover:bg-white/10 rounded-full px-8 backdrop-blur-md bg-white/5"
              >
          ...
          >
            <div className="relative w-80 h-80 lg:w-[400px] lg:h-[400px] mx-auto">
              ...
              <div className="relative h-full w-full rounded-[2rem] overflow-hidden border border-white/10 bg-white/5 backdrop-blur-sm shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500">
                <img
                  src="/me.png"
                  alt="Asraful Islam"
