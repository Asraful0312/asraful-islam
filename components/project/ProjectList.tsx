      ...
      <div className="section-container pt-24 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="bg-card rounded-3xl overflow-hidden border border-border h-[400px] flex flex-col"
            >
              <Skeleton className="w-full aspect-[15/7] bg-muted" />
        ...
        >
          {filteredProject.map((project) => (
            <motion.div
              ...
              className="bg-card rounded-3xl overflow-hidden border border-border project-card shadow-sm hover:shadow-md transition-shadow"
              whileHover={{ y: -10 }}
            >
              <div className="relative overflow-hidden aspect-[15/7]">
                <img
                  ...
                  alt={project.name}
                  className="w-full h-full object-contain transition-transform duration-500 hover:scale-110 oveflow-hidden bg-secondary/20"
                />
              </div>
              <div className="p-6">
                <Link
                  href={`/projects-details/${project._id}`}
                  className="text-xl font-bold mb-2 text-foreground hover:text-jordy_blue-500 transition-colors"
                >
                  {project.name}
                </Link>
